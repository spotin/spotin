...
return [
	...
	"array_keys" =>
		"Le champ :attribute ne doit contenir que les clés suivantes : :values.",
	"ascii" =>
	...
	"doesnt_contain" =>
		"Le champ :attribute ne doit contenir aucun des éléments suivants : :values.",
	"doesnt_end_with" =>
	...
	"extensions" =>
		'Le champ :attribute doit avoir l\'une des extensions suivantes : :values.',
	...
	"hex_color" =>
		"Le champ :attribute doit être une couleur hexadécimale valide.",
	"image" => "Le champ :attribute doit être une image.",
	"in" => "Le champ :attribute est invalide.",
	"in_array" => 'Le champ :attribute n\'existe pas dans :other.',
	"in_array_keys" =>
		'Le champ :attribute doit contenir au moins l\'une des clés suivantes : :values.',
	...
	"max" => [
		"array" =>
			"Le tableau :attribute ne peut pas contenir plus que :max éléments.",
		"file" =>
		...
		"string" =>
			"Le texte de :attribute ne peut pas contenir plus de :max caractères.",
	],
	"max_digits" =>
	...
	"min" => [
		...
		"file" =>
			"La taille du fichier de :attribute doit être supérieure ou égale à :min kilo-octets.",
		"numeric" =>
			"La valeur de :attribute doit être supérieure ou égale à :min.",
		"string" =>
			"Le texte de :attribute doit contenir au moins :min caractères.",
	],
	...
	"password" => [
		...
		"mixed" =>
			"Le champ :attribute doit contenir au moins une majuscule et une minuscule.",
	...
	"present_if" =>
		"Le champ :attribute doit être présent lorsque :other est :value.",
	"present_unless" =>
		"Le champ :attribute doit être présent sauf si :other vaut :value.",
	"present_with" =>
		"Le champ :attribute doit être présent lorsque :values est présent.",
	"present_with_all" =>
		"Le champ :attribute doit être présent lorsque :values sont présents.",
	"prohibited" => "Le champ :attribute est interdit.",
	"prohibited_if" =>
		"Le champ :attribute est interdit quand :other a la valeur :value.",
	"prohibited_if_accepted" =>
		"Le champ :attribute est interdit quand :other a été accepté.",
	"prohibited_if_declined" =>
		"Le champ :attribute est interdit quand :other a été refusé.",
	"prohibited_unless" =>
	...
	"required_if_declined" =>
		"Le champ :attribute est obligatoire quand le champ :other a été refusé.",
	"required_unless" =>
